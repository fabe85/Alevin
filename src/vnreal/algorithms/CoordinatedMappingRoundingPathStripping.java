 ...
 * 
 * 
 * This node mapping algorithm is a proposal of:
...
import vnreal.algorithms.linkmapping.RoundingPathStrippingLinkMapping;
import vnreal.algorithms.nodemapping.CoordinatedVirtualNodeMapping;
import vnreal.algorithms.utils.MiscelFunctions;
import vnreal.network.NetworkStack;

public class CoordinatedMappingRoundingPathStripping extends
		GenericMappingAlgorithm {
	public CoordinatedMappingRoundingPathStripping(NetworkStack stack,
			int dist, double wCpu, double wBw, int type, int k,
		...
		super(MiscelFunctions.sortByRevenues(stack),
				...
				new RoundingPathStrippingLinkMapping(stack.getSubstrate(),
						wCpu, wBw, k, type));
	}
}
