 ...
 * through topology-aware node ranking, SIGCOMM Comput. Commun. Rev. 41 (2011) 38Ð47.
 * 
...
public class BFSCoordinatedVneAlgorithm extends GenericMappingAlgorithm {

	public BFSCoordinatedVneAlgorithm(NetworkStack stack, int k, int dist,
			boolean withDist, boolean nodeOverload) {
		super(MiscelFunctions.sortByRevenues(stack),
				new BFSNRCoordinatedMapping(stack.getSubstrate(), nodeOverload,
						0.0001, withDist, dist, k), new FoolLinkMapping(stack
						.getSubstrate()));
