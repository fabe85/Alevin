...
import tests.generators.demand.FixedBandwithDemandGenerator;
...
import tests.generators.resource.FixedBandwithResourceGenerator;
...
public class AdvSubgraphTestRunner extends AbstractTestRunner {
	...
	public AdvSubgraphTestRunner(XMLExporter exporter) {
		...
		mResGens.add(new FixedBandwithResourceGenerator());
		...
		mDemGens.add(new FixedBandwithDemandGenerator());
