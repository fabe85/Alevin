...
public class GeneratorTestGenerator extends AbstractTestGenerator {
	...
	public GeneratorTestGenerator(String seriesName) {
		...
		mParams.add(new SimpleEntry<String, Object[]>("Min_Bandwidth", min)); //for Bandwith Generators
		mParams.add(new SimpleEntry<String, Object[]>("Max_Bandwidth", max)); //for Bandwith Generators
		...
		mParams.add(new SimpleEntry<String, Object[]>("Min_CPU", min)); //For CPU generators
		mParams.add(new SimpleEntry<String, Object[]>("Max_CPU", max)); //For CPU generators
